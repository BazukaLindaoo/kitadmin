-- This script not is open-source, this is the official Kit Kat Hub page made by Bazuka.
...
local Window = Libary:MakeWindow({
    Title = "Kit Kat Hub - Kit Kat Developers Brookhaven",
    SubTitle = "by: Kit Kat Developers (Wx, Lolyta, Bazuka, Luscaa)",
    LoadText = "Kit Kat Developers",
...
InfoTab:AddParagraph({ "Você está usando:", "Kit Kat Hub" })
...
TrollTab:AddSection({ "Jujutsu Kaisen - Bazuka" })
TrollTab:AddButton({
...
if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then 
    TextChatService.TextChannels.RBXGeneral:SendAsync(
        "hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r[⚠️AVISO] UM TORNADO SURGIU! Kit Kat Hub by Wx"
    )
else 
    print("Nadaa")
end
...
TrollTab:AddButton({
    ...
    Callback = function()
        ...
        if not success then
            ...
            print("[Kit Kat Hub] Tornado finalizado e veículos deletados.")
        end
    end
})
...
local names = {
    ...
    {"TUBERS93", " TUBERS 93 "},
    {"CO0LKID", " CO0 LKID "},
    {"GAME ATTACKED BY Kit Kat", " GAME ATTACKED BY Kit Kat "},
    {"INC0MUN", " INC0MUN"},
    {"BAD BOY", " BAD BOY "}
}
...
LocalPlayerTab:AddButton({
    Name = "Spam chat Hacked By Kit Kat",
    Callback = function()
        if game:GetService("TextChatService").ChatVersion == Enum.ChatVersion.TextChatService then 
            game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\rServer: Hacked by Kit Kat Hub")
        else 
            print("Nadaa")
    end
end
...
--// ================================
--// ADMIN PANEL - KitKat Hub (Integrado)
--// ================================
local Players = game:GetService("Players")
local player = Players.LocalPlayer
local TextChatService = game:GetService("TextChatService")
...
local function isAdmin(plr)
    local admins = {"Breno010L", "itz_kadu22", "Saitama9rsm"}
...
-- Sistema do comando ;verifique (funciona para TODOS players)
local function setupVerifiqueListener()
        ...
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
            if TextChatService.MessageReceived then
                TextChatService.MessageReceived:Connect(function(message)
                    ...
                    if sender and typeof(text) == "string" and text:lower() == ";verifique" then
                        local channel = TextChatService.TextChannels and TextChatService.TextChannels.RBXGeneral
                        if channel then
                            channel:SendAsync("KitKat Hub on Top!")
                        end
                    end
                end)
            else
                local prev = TextChatService.OnIncomingMessage
    ...
    if not ok then
        warn("KitKat Hub: falha ao conectar ;verifique -> " .. tostring(err))
    end
end
setupVerifiqueListener()

-- Funções de comando
local function runCommand(cmd, plr)
    ...
    elseif cmd == ";kick" then
        pcall(function()
            plr:Kick("Expulso pelo admin do KitKat Hub")
        end)
...
local function createAdminGUI()
    ...
    local ScreenGui = Instance.new("ScreenGui")
    ScreenGui.Name = "KitKatHubAdminPanel"
    ScreenGui.ResetOnSpawn = false
    ...
    Title.Text = "KitKat Hub • Painel Admin"
    ...
    ListFrame.Size = UDim2.new(0,300,0,160)
    ListFrame.Position = UDim2.new(0,25,0,95)
    ...
    local y0 = 270
    createButton("Kill", y0 +  0,  function(plr) runCommand(";kill", plr) end)
    createButton("Kick", y0 + 50,  function(plr) runCommand(";kick", plr) end)
    createButton("Freeze", y0+100, function(plr) runCommand(";freeze", plr) end)
    createButton("Unfreeze", y0+150,function(plr) runCommand(";unfreeze", plr) end)
    createButton("Jail", y0 +200,  function(plr) runCommand(";jail", plr) end)
    createButton("Unjail", y0+250, function(plr) runCommand(";unjail", plr) end)
    createButton("Verifique", y0+300,function(plr) runCommand(";verifique", plr) end)
end
...
if isAdmin(player) then
    ...
    player.CharacterAdded:Connect(function()
        task.wait(0.5)
        if not player.PlayerGui:FindFirstChild("KitKatHubAdminPanel") then
            createAdminGUI()
        end
    end)
end
